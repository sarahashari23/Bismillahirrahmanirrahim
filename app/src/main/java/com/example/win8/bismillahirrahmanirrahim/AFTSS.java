...
public class AFTSS extends AppCompatActivity {    private ListView lvItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aftss);

        getSupportActionBar().setTitle("Medicine lists"); //tampil title

        lvItem = (ListView) findViewById(R.id.list_view);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AFTSS.this, android.R.layout.simple_list_item_1, android.R.id.text1, obatSarah);
    /*
    Step 2
     ...
     */
        ...
        lvItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(AFTSS.this, "Memilih : "+obatSarah[position], Toast.LENGTH_LONG).show();
